...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Person">
      ...
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-MPIState']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-MPIState': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:identifier/f:period</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:name/f:family</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Person/f:telecom">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/telecom-source']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/telecom-source': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:value) &gt;= 1">value: minimum cardinality of 'value' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Person/f:address">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-department']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-department': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-province']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-province': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-district']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/Extension-district': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-user-label']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-user-label': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-user-additional-info']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-user-additional-info': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-inside']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-inside': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-last-ship-address']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-last-ship-address': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-source']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-source': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-hidden-from-user']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-hidden-from-user': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-latitude']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-latitude': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://fhir.onehealth.com.pe/StructureDefinition/address-longitude']) &lt;= 1">extension with URL = 'https://fhir.onehealth.com.pe/StructureDefinition/address-longitude': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:text) &gt;= 1">text: minimum cardinality of 'text' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Person/f:link</sch:title>
